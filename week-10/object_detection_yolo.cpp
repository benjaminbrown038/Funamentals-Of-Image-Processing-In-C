// Usage example:  ./build/object_detection_yolo.out --video=run.mp4
//                 ./build/object_detection_yolo.out --image=bird.jpg
#include <fstream>
#include <sstream>
#include <iostream>
...
const char* keys =
"{help h usage ? | | Usage examples: \n\t\t./build/object_detection_yolo.out --image=dog.jpg \n\t\t./build/object_detection_yolo.out --video=../data/videos/run_sm.mp4}"
